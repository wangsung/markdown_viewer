(async function() {
    ...
    htmlText = htmlText.replace(/src=(["'])(frame-man\.js|export-man\.js|preview-man\.js|editor-man\.js|style-editor\.js|scroll-sync\.js|settings-man\.js|app\.js)(\?[^"'>]*)?\1/g, `src=$1${extensionBaseUrl}$2$3$1`);
